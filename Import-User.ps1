...
ForEach ($User in $NewUsersList) {
    ...
    # Récupération du nom d’ouverture de session de l’utilisateur
	$sAMAccountName = $User.sAMAccountName
	
    # Récupération du nom d’ouverture de session de l’utilisateur » concaténé au nom du domaine
    ...
    # Ajout de l'utilisateur dans le groupe pour accès au fichier de son service
